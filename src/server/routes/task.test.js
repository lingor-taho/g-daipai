...
function testActiveBiddingQueryIncludesHighestAndOutbidStatuses() {
  ...
  assert.match(query.sql, /CASE/);
  assert.match(query.sql, /remaining_time_text LIKE '%分'/);
  assert.match(query.sql, /remaining_time_text LIKE '%時間'/);
  assert.match(query.sql, /remaining_time_text LIKE '%日'/);
